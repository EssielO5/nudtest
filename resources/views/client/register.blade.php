...
@section('client')
<title>Nùdutin - Inscription client</title>
                        ...
                        <div class="main">
                            <form method="post" action="{{ route('client.register.create') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Nom *" name="name" value="{{ old('name') }}" type="text">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <i class="icon_pencil"></i>
                                    <input class="form-control" placeholder="Téléphone *" name="phone" value="{{ old('phone') }}" type="text">
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
