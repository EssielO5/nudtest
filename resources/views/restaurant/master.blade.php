...
<head>
    ...
    <meta name="description" content="Découvrez les restaurants">
    ...
    <title>Nùdutin - Restaurant dashboard</title>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Chat">
                    <a class="nav-link" href="{{ route('restaurant.chat.dashboard') }}">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My listings">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseMylistings">
                        <li>
                            <a href=" {{route('restaurant.menus')  }}">Tous les menus <span class="badge badge-pill badge-primary"></span></a>
                        </li>
                        <li>
                            <a href="{{ route ('restaurant.menu.add') }}">Créer un menu <span class="badge badge-pill badge-success"></span></a>
                        </li>
                        {{-- <li>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My listings">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseMylistings2">
                        <li>
                            <a href=" {{route('restaurant.categories')  }}">Toutes les catégories <span class="badge badge-pill badge-primary"></span></a>
                        </li>
                        <li>
                            <a href="{{ route ('restaurant.category.add') }}">Créer une catégorie <span class="badge badge-pill badge-success"></span></a>
                        </li>
                        {{-- <li>
                            <a href="listings.html">Expired <span class="badge badge-pill badge-danger">6</span></a>
                        </li> --}}
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My listings">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseMylistings3">
                        <li>
                            <a href=" {{route('restaurant.plats')  }}">Tous les plats <span class="badge badge-pill badge-primary"></span></a>
                        </li>
                        <li>
                            <a href="{{ route ('restaurant.plat.add') }}">Créer un plat <span class="badge badge-pill badge-success"></span></a>
                        </li>
                        {{-- <li>
                            <a href="listings.html">Expired <span class="badge badge-pill badge-danger">6</span></a>
                        </li> --}}
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                    <a class="nav-link" href="{{ route('restaurant.payment.keys') }}">
                        <i class="fa fa-fw fa-list"></i>
                        <span class="nav-link-text">FedaPay</span>
                    </a>
                </li>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @if (Auth::guard('restaurant')->user()->unreadnotifications->count() > 0)
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route ('restaurant.notifications') }}"> <i class="fa-solid fa-bell text-white"></i> <span class="badge badge-danger">{{ Auth::guard('restaurant')->user()->unreadnotifications->count() }}</span></a>
                    </li>
                @endif
                <li class="nav-item">
    ...
    <footer class="sticky-footer">
        <div class="container">
            <div class="text-center">
                <small>Copyright © Nùdutin 2024</small>
            </div>
        </div>
    </footer>
